CREATE OR REPLACE FUNCTION public.post_loan_payment_rpc(p_loan_id text, p_period integer, p_date text, p_interest_to_pay numeric) RETURNS jsonb LANGUAGE plpgsql
AS $function$
    DECLARE
        v_loan RECORD;
        v_principal NUMERIC;
    ...
    BEGIN
        ...
        IF v_is_received THEN
            ...
            -- User specifically requested 500208 LOAN PROFIT
