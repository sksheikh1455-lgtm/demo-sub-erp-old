...
async function main() {
  ...
  try {
      ...
      // Update any remaining docs_payments that still point to string 'contact-cash-sale-global'
      // That's another potential issue, but right now the problem was duplicate "SHEIKH ELECTRIC KALIYA".
