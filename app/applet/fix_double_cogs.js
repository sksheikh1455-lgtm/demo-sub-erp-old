...
async function run() {
  ...
  // Now, let's clean up existing duplicates for all invoices
  // Specifically, we want to delete 'JL-JE-XXX-cogs-1' etc where a '-mov-' version exists.
  // Actually, better to just delete ALL '-cogs-1' lines from invoice journals, since stock movements generate their own.
