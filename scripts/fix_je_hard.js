...
async function run() {
  ...
  try {
    // Disable triggers to allow deletion
    ...
    await client.query(`
      INSERT INTO docs_journals (id, company_id, journal_number, date, journal_date, journal_type, status, description)
      VALUES ($1, 'comp-1', 'JE-REC-EMSG-001', '2026-06-04', '2026-06-04', 'OPENING_BALANCE', 'POSTED', 'Opening Balance: Monthly Savings / Loan Receivable')
    `, [newJeId]);
