...
BEGIN
    ...
    v_opening_balance := COALESCE(v_opening_balance, 0) + COALESCE((
    ...
    WITH filtered_txs AS (
        SELECT 
            ...
            j.prepared_by as prepared_by,
            j.data->>'createdById' as created_by_id,
            l.debit,
            l.credit,
            l.description,
            l.id as line_id,
    ...
    RETURN jsonb_build_object(
        'openingBalance', COALESCE(v_opening_balance, 0),
